      ...
      try {
        ...
        const overallConfidence = Math.round(
          (scores.confidence.plan_flow +
            ...
            scores.confidence.comfort_adventure +
        ...
        const { error: profileError } = await upsertTravelerProfile(supabase, {
          ...
          comfort_adventure_score: scores.comfort_adventure_score,
        ...
        analytics.logSwipeCompleted({
          ...
          comfort_adventure: scores.comfort_adventure_score,
      ...
      try {
        ...
        const overallConfidence = Math.round(
          (updatedConfidence.plan_flow +
            ...
            updatedConfidence.comfort_adventure +
        ...
        const { error: profileError } = await upsertTravelerProfile(supabase, {
          ...
          comfort_adventure_score: updatedScores.comfort_adventure_score,
        ...
        const finalScores = {
          ...
          comfort_adventure: updatedScores.comfort_adventure_score,
    ...
    return (
      <DreamDayCreator
        currentScores={{
          ...
          comfort_adventure_score: swipeScores.comfort_adventure_score,
    ...
    return (
      <TypeReveal
        ...
        scores={{
          ...
          comfort_adventure_score: revealData.comfort_adventure_score,
