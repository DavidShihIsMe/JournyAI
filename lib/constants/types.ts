...
export const TRAVELER_TYPES: Record<string, TravelerTypeInfo> = {
  ...
  FBAO: {
    ...
    description:
      "You go wherever the wind takes you, comfortable with uncertainty and distance. You don't need a plan or a crowd — just open road and open time.",
    portrait:
